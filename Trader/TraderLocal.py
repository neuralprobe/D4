...
class TraderLocal:
    ...
    def __init__(self):
        ...
        self.symbol_manager = SymbolManager(max_symbols=-1, asset_filter_rate=0.05, renew_symbol=True, max_workers=30)
...
if __name__ == "__main__":
    ...
    start = '2024-10-01 09:31:00'
    end = '2024-10-30 16:00:00'
